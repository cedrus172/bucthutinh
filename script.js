function showResult() {
    var receiver = document.getElementById('receiverTxt');
    var address = document.getElementById('addressTxt');
    var timeSend = document.getElementById('timeSendTxt');
    var result = document.getElementById('resultTxt');

    result.innerHTML = receiver.value + " thương nhớ,<br>\
